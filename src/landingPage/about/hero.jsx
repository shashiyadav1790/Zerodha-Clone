    ...
    return (  
        <div className="container">
            <div className="row  mt-5 p-3">
                <h2 className="text-center mb-5 mt-5 p-5" style={{color: '#424242'}}>We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h2>
